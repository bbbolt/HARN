...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        name, data_range = f"{model_id:01}_HARN_baseline", 1.0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default=r"C:\SR\NTIRE2024_ESR-main\datasets", type=str)
    parser.add_argument("--save_dir", default=r"C:\SR\NTIRE2024_ESR-main\results", type=str)
    parser.add_argument("--model_id", default=41, type=int)
